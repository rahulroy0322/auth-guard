...
import { AuthBadError, AuthConflictError, AuthError, AuthExpiredError, AuthNoTokenError, AuthServerError, AuthUnAuthenticatedError, AuthWrongTokenError } from "./error"
import type { AuthType, CheckAuthType, LoginRequiredType, LoginType, LogType, RegisterType, TokenRefreshType, UserType } from "./types"
...
const init: AuthType = ({
    ...
    const signTokens = (props: {
        ...
        const access = signToken({ id, type: 'access' },
            jwt.secret, {
